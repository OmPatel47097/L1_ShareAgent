...
# installed.
TCL_PREFIX='A:/EndToEnd_Projects/Agentic_Ai/L1_Project/venv_agenticai\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='A:/EndToEnd_Projects/Agentic_Ai/L1_Project/venv_agenticai\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='A:/EndToEnd_Projects/Agentic_Ai/L1_Project/venv_agenticai\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IA:/EndToEnd_Projects/Agentic_Ai/L1_Project/venv_agenticai\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LA:/EndToEnd_Projects/Agentic_Ai/L1_Project/venv_agenticai\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='A:/EndToEnd_Projects/Agentic_Ai/L1_Project/venv_agenticai\Library\lib\tclstub86.lib'
